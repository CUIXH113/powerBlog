...
<!-- 						<div class="form-group">
	...
	<script src="/powermclblog/js/supersized.3.2.7.min.js"></script>
	<script src="/powermclblog/js/supersized-init.js"></script>
	<script src="/powermclblog/js/scripts.js"></script>
