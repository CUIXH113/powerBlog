...
<html lang="en">
	...
	<body>
		<div class="container" >
				<form action="${pageContext.request.contextPath}/financialStatement/addBalanceSheet" method="post" >
					<div class="form-row" align="center">
						<div class="form-group col-md-12">
							 <h2 class="display-4" style="color: green;"><em>新增资产负债表</em></h2>
				  ...
				  <div class="form-row bg-light">
				    <div class="form-group col-md-2">
				      ...
				      <input type="text" class="form-control" id="monetaryFund" name="monetaryFund">
				    </div>
 				    <div class="form-group col-md-2" style = "margin-left: 40px;">
				      ...
				      <input type="text" class="form-control" id="accountsReceivable" name = "accountsReceivable">
				    </div>
				    <div class="form-group col-md-2" style = "margin-left: 40px;">
				    	<label for="receivableOther" class="col-form-label" style="color: green;"><strong>其他应收款</strong></label>
				    	<input type = "text" class = "form-control" id = "receivableOther" name = "receivableOther">
				    </div>
				  ...
				  <div class="form-row bg-light" >
			    	<div class = "form-group col-md-2" >
				    	...
				    	<input type = "text" class = "form-control" id = "advancePayment" name = "advancePayment"/>
				    </div>				  
				  	<!-- 姓名 -->
				    <div class="form-group col-md-2" style = "margin-left: 40px;">
				    ...
				    <div class="form-group col-md-2" style = "margin-left: 40px;">
				    	...
				    	<input type="text" class="form-control" id="prepaidExpenses" name="prepaidExpenses">
				    </div>
				       <!-- 年龄 -->
				    <div class="form-group col-md-2" style = "margin-left: 40px;">
				    	<label for="otherLiquidAssets" class="col-form-label" style="color: green;"><strong>其他流动资产</strong></label>
				    	<input type="text" class="form-control" id="otherLiquidAssets" name="otherLiquidAssets">
				    </div>	
				...
				<div class = "form-row bg-light">
					<div class = "form-group col-md-2">
						...
						<input type = "text" class = "form-control" id = "longTermInvestment" name = "longTermInvestment"/>
					</div>
					<div class = "form-group col-md-2" style = "margin-left: 40px;">
						<label for = "solidAssets" class = "col-form-label" style = "color: green;"><strong>固定资产</strong></label>
						<input type = "text" class = "form-control" id = "solidAssets" name = "solidAssets"/>
					</div>
					<div class = "form-group col-md-3" style = "margin-left: 40px;">
						...
						<input type = "text" class = "form-control" id = "otherAssets" name = "otherAssets"/>
					</div>
				</div>
				<div class = "form-row bg-primary">
					<h2>负债：流动负债</h2>
				...
				<div class = "form-row bg-light">
					<div class = "form-group col-md-2">
						...
						<input type = "text" class = "form-control" id = "shortTermBorrowing" name = "shortTermBorrowing"/>
					</div>
					<div class = "form-group col-md-2" style = "margin-left: 40px;">
						<label for = "accountsPayable" class = "col-form-label" style = "color: green;"><strong>应付账款</strong></label>
						<input type = "text" class = "form-control" id = "accountsPayable" name = "accountsPayable"/>
					</div>
				...
				<div class = "form-row bg-light">
					...
					<div class = "form-group col-md-3">
						...
						<input type = "text" class = "form-control" id = "otherPayable" name = "otherPayable"/>
					</div>
					<div class = "form-group col-md-3" style = "margin-left: 40px;">
						<label for = "deferredRevenue" class = "col-form-label" style = "color: green;"><strong>预收账款</strong></label>
						<input type = "text" class = "form-control" id = "deferredRevenue" name = "deferredRevenue"/>
					</div>
					<div class = "form-group col-md-2">
						<label for = "otherDeferredRevenue" class = "col-form-label" style = "color: green;"><strong>短期借款</strong></label>
						<input type = "text" class = "form-control" id = "otherDeferredRevenue" name = "otherDeferredRevenue"/>
					</div>					
				</div>				
				...
				<div class = "form-row bg-light">
					<div class = "form-group col-md-2">
						...
						<input type = "text" class = "form-control" id = "longTermBorrow" name = "longTermBorrow"/>
					</div>
					<div class = "form-group col-md-2" style = "margin-left: 40px;">
						<label for = "shouldPayBond" class = "col-form-label" style = "color: green;"><strong>应付债券</strong></label>
						<input type = "text" class = "form-control" id = "shouldPayBond" name = "shouldPayBond"/>
					</div>
				...
				<div class = "form-row bg-light">			
					<div class = "form-group col-md-3">
						...
						<input type = "text" class = "form-control" id = "longTermShouldPay" name = "longTermShouldPay"/>
					</div>
					<div class = "form-group col-md-3" style = "margin-left: 40px;">
						<label for = "otherNonLiquidDebt" class = "col-form-label" style = "color: green;"><strong>其他非流动负债</strong></label>
						<input type = "text" class = "form-control" id = "otherNonLiquidDebt" name = "otherNonLiquidDebt"/>
					</div>				
				</div>						
				<div class = "form-row bg-primary">
					<h2>负债：所有者权益</h2>
				...
				<div class = "form-row bg-light">
					<div class = "form-group col-md-3">
						...
						<input type = "text" class = "form-control" id = "paidInCapita" name = "paidInCapita"/>
					</div>	
					<div class = "form-group col-md-3" style = "margin-left: 40px;">
						<label for = "capitalReserves" class = "col-form-label" style = "color: green;"><strong>资本公积</strong></label>
						<input type = "text" class = "form-control" id = "capitalReserves" name = "capitalReserves"/>
					</div>
					<div class = "form-group col-md-3" style = "margin-left: 40px;">
						<label for = "surplusReserves" class = "col-form-label" style = "color: green;"><strong>盈余公积</strong></label>
						<input type = "text" class = "form-control" id = "surplusReserves" name = "surplusReserves"/>
					</div>
					<div class = "form-group col-md-3">
						<label for = "retainedEarnings" class = "col-form-label" style = "color: green;"><strong>留存收益</strong></label>
						<input type = "text" class = "form-control" id = "retainedEarnings" name = "retainedEarnings"/>
					</div>					
				</div>		
