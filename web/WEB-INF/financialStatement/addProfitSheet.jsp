...
<html lang="en">
	...
	<body>
		<div class="container" >
				<form action="${pageContext.request.contextPath}/financialStatement/addProfitStatement" method="post" >
					<div class="form-row" align="center">
						<div class="form-group col-md-12">
							 <h2 class="display-4" style="color: green;"><em>新增利润表</em></h2>
				  ...
				  <div class="form-row bg-light">
				    <div class="form-group col-md-2">
 				    ...
 				    <div class="form-group col-md-2" style = "margin-left: 40px;">
				      ...
				      <input type="text" class="form-control" id="operatingCost" name = "operatingCost">
				    </div>
				    <div class="form-group col-md-2" style = "margin-left: 40px;">
				    	<label for="operatingTaxAndAdditional" class="col-form-label" style="color: green;"><strong>营业税金及附加</strong></label>
				    	<input type = "text" class = "form-control" id = "operatingTaxAndAdditional" name = "operatingTaxAndAdditional">
				    </div>
				  ...
				  <div class="form-row bg-light" >
				    ...
				    <div class="form-group col-md-2" style = "margin-left: 40px;">
				      ...
				      <input type="text" class="form-control" id="managementFees" name="managementFees">
				    </div>
				    <!-- 年龄 -->
				    <div class="form-group col-md-2" style = "margin-left: 40px;">
				    	<label for="financeCharges" class="col-form-label" style="color: green;"><strong>财务费用</strong></label>
				    	<input type="text" class="form-control" id="financeCharges" name="financeCharges">
				    </div>
				       <!-- 年龄 -->
				    <div class="form-group col-md-2" style = "margin-left: 40px;">
				    	<label for="assetsImpairmentLoss" class="col-form-label" style="color: green;"><strong>资产减值损失</strong></label>
				    	<input type="text" class="form-control" id="assetsImpairmentLoss" name="assetsImpairmentLoss">
				    </div>	
				...
				<div class = "form-row bg-light">
					<div class = "form-group col-md-2">
						...
						<input type = "text" class = "form-control" id = "benefitsOfFairValueChange" name = "benefitsOfFairValueChange"/>
					</div>
					<div class = "form-group col-md-2" style = "margin-left: 40px;">
						<label for = "incomeFromInvestment" class = "col-form-label" style = "color: green;"><strong>投资收益</strong></label>
						<input type = "text" class = "form-control" id = "incomeFromInvestment" name = "incomeFromInvestment"/>
					</div>
					<div class = "form-group col-md-3" style = "margin-left: 40px;">
						...
						<input type = "text" class = "form-control" id = "jointVentureIncome" name = "jointVentureIncome"/>
					</div>
				</div>
				...
				<div class = "form-row bg-light">
					<div class = "form-group col-md-2">
						...
						<input type = "text" class = "form-control" id = "operatingProfit" name = "operatingProfit"/>
					</div>
					<div class = "form-group col-md-2" style = "margin-left: 40px;">
						<label for = "nonOperatingIncome" class = "col-form-label" style = "color: green;"><strong>营业外收入</strong></label>
						<input type = "text" class = "form-control" id = "nonOperatingIncome" name = "nonOperatingIncome"/>
					</div>
				...
				<div class = "form-row bg-light">
					...
					<div class = "form-group col-md-3">
						...
						<input type = "text" class = "form-control" id = "nonOperatingExpenditure" name = "nonOperatingExpenditure"/>
					</div>
					<div class = "form-group col-md-3" style = "margin-left: 40px;">
				...
				<div class = "form-row bg-light">
					<div class = "form-group col-md-2">
						...
						<input type = "text" class = "form-control" id = "netProfit" name = "netProfit"/>
					</div>
				</div>	
				  <div class="form-row bg-light">
