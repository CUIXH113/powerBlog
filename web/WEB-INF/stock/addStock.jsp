			...
			<div class="col-lg-12 p-3 mb-2 bg-light text-gray-dark">
				<div class="form-row" align="center">
						<div class="form-group col-md-12">
							 <h2 class="display-4" "><em>新增${companyName}股票</em></h2>
						</div>
				</div>
			...
			<%-- 		<!-- 公司名字-->
				  <div class="form-row">
				    <div class="form-group col-md-4">
				      <label for="companyName" class="col-form-label" ><strong>公司名字</strong></label>
				      <!-- <input type="text" class="form-control" id="companyName" name="companyName" placeholder="公司名字"> -->
				      <div>
					      <select id = "companyName" name = "companyName" class="custom-select"  style="height:36px; width:160px;">
				  ...
				  <div class="form-row">
				  	<input type="text" id = "companyName" class="form-control" name = "companyName" value = "${companyName}" hidden = "true"/>
				  	<!-- 股票代码 -->
				    ...
				    <div class = "form-group col-md-2" style="padding-left:15px;">
				    	...
				    	<div>
					    	<input type="date" id = "marketListingTime" name = "marketListingTime" style="width:160px;"/>
				    	</div>
				    </div>
				      <!-- 股票类型 -->
				    <div class="form-group col-md-2">
				    	<label for="stockFlag" class="col-form-label" ><strong>股票类型</strong></label>
				  		<div id="stockFlag">
					      <select  class="custom-select" name="stockFlag" style="height:36px; width:160px;">
				    ...
				    <div class="form-group col-md-2">
					  ...
					  <input type="text" class="form-control" id="totalStockNum" name="totalStockNum">
				    </div>
				    <div class="form-group col-md-2">
				      <label for="unit" class="col-form-label" ><strong>单位</strong></label>
				      <div>
						  <select  class="form-control" id="unit" name="unit" style="height:36px; width:160px;">
